...
public class UserController {
    ...
    public void showMenu(){
        ...
        int totalFines;
        if(Main.loggedInUser.getStatus().equalsIgnoreCase("expired")) {
            System.out.println("Ditt medlemskap har gått ut. Vänligen kontakta en bibliotekarie för att återaktivera det.");
        } else {
            while (active) {
